...
>
  {window.innerWidth < 700 || window.innerHeight < 580 ? (
    <div className="flex items-center justify-center h-screen">
      <h2 className="text-lg font-bold text-center text-red-500">
        Please switch to a desktop or laptop screen to view this page.
      </h2>
    </div>
  ) : (
    <>
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <span className="animate-blink text-red-500 font-semibold">
          Note: Enter your details below, then click the Download button to
          issue your Email Signature.
        </span>
